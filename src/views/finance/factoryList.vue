    ...
    <div class="module">
      ...
      <div class="listCtn">
        <div class="filterCtn">
          ...
          <div class="rightCtn" style="min-width: unset">
        ...
        <div class="list">
          ...
          <div class="bodyCtn">
            ...
            <div class="row">
              ...
              <div class="column green" v-else>{{ $toFixed(total_sts.collection_total_price || 0, 2, true) }}元</div>
              <div class="column green" v-if="openWMoneyShow">
                {{ $toFixed(total_sts.invoice_total_price || 0, 2, true) }}万元
              </div>
              <div class="column green" v-else>{{ $toFixed(total_sts.invoice_total_price || 0, 2, true) }}元</div>
              <div class="column green" v-if="openWMoneyShow">
                {{ $toFixed(total_sts.deduct_total_price / 10000, 2, true) }}万元
              </div>
              <div class="column green" v-else>{{ $toFixed(total_sts.deduct_total_price || 0, 2, true) }}元</div>
              <div class="column green" v-if="openWMoneyShow">
